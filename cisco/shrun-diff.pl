...
my $maindir  = "/home/cisco_watcher/shrun_diff";
...
my $msg = "To: <abuse\@microsoft.pl>
Content-Type: text/plain;
        charset=\"iso-8859-2\"
From: Watcher <monkey\@banana.republic>
Subject: [RUN DIFF] Raport zmian w konfiguracji urzadzen z $time
